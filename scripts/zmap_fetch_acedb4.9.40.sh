...
export ZMAP_ACEDB_RELEASE_CONTAINER

$CURRENT/zmap_fetch_acedbbinaries.sh $ZMAP_TARGET DEVELOPMENT ZMAP_ACEDB_RELEASE_CONTAINER=$ZMAP_ACEDB_RELEASE_CONTAINER ZMAP_MASTER_HOST=$(hostname) ZMAP_ACEDB_VERSION_DIR=4 || \
    { echo "Failed!" ; exit 1; }
