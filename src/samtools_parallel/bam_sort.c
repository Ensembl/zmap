...
#ifdef _PBGZF_USE 
//        fprintf(stderr,"Setting number of threads per to 1\n");
...
#ifdef _PBGZF_USE 
//        fprintf(stderr,"Setting number of threads per to 2\n");
        bam_set_num_threads_per(6);
#endif
...
{
#ifndef _PBGZF_USE 
	int c, is_by_qname = 0, flag = 0, ret = 0, n_threads = 3, level = -1;
#else
...
int bam_sort(int argc, char *argv[])
{
	...
	int c, is_by_qname = 0, is_stdout = 0, n_threads = 3, level = -1, sort_type = 0;
...
#ifdef _PBGZF_USE 
        bam_set_num_threads_per(n_threads);
#endif
