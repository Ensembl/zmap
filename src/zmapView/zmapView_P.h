...
gboolean zmapViewScratchCopyFeature(ZMapView zmap_view, ZMapFeature feature, FooCanvasItem *item, const double world_x, const double world_y, ZMapFeatureSubPartSpan subfeature);
gboolean zmapViewScratchDeleteFeature(ZMapView zmap_view, ZMapFeature feature, FooCanvasItem *item, const double world_x, const double world_y, ZMapFeatureSubPartSpan subfeature);
