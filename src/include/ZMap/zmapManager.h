 ...
 * Description: 
 * HISTORY:
 * Last edited: Feb 26 08:15 2004 (edgrif)
 * Created: Thu Jul 24 14:39:06 2003 (edgrif)
 * CVS info:   $Id: zmapManager.h,v 1.1 2004-03-03 12:51:52 edgrif Exp $
 *-------------------------------------------------------------------
 */
...
gboolean zMapManagerLoadData(ZMapManager zmaps, ZMap zmap) ;
