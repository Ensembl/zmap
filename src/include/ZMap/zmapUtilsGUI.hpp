...
typedef enum 
{
  ZMAPGUI_HELP_GENERAL,
  ZMAPGUI_HELP_QUICK_START,
  ZMAPGUI_HELP_ALIGNMENT_DISPLAY,
  ZMAPGUI_HELP_RELEASE_NOTES,
  ZMAPGUI_HELP_KEYBOARD,
  ZMAPGUI_HELP_FILTER,
  ZMAPGUI_HELP_MANUAL
} ZMapHelpType ;
...
void zMapGUIMakeMenu(const char *menu_title, GList *menu_sets, GdkEventButton *button_event) ;
