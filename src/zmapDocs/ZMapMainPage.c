 ...
 * 
 * ZMap is a stand alone client successor to FMap, the main virtual
 * sequence viewer/annotation tool of Acedb.
 * 
 * \section license ZMap License
 * 
 * Copyright (c) 2004 <A href="http://www.sanger.ac.uk/">Sanger Institute</A>
 *
 * Permission to use, copy, modify, and distribute this software and its documentation
 * under the terms of the GNU General Public License is hereby granted.
 * No representations are made about the suitability of this software for any purpose.
 * It is provided "as is" without express or implied warranty.
 * See the
 * <A href="http://www.gnu.org/copyleft/gpl.txt">GNU General Public License</A>
 * for more details.
 * 
