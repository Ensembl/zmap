...
ZMapStyleParamStruct zmapStyleParams_G[_STYLE_PROP_N_ITEMS] =
{
  ...
  { STYLE_PROP_GRAPH_LINE_FILL, STYLE_PARAM_TYPE_BOOLEAN, ZMAPSTYLE_PROPERTY_GRAPH_LINE_FILL,
    "graph-line-fill", "Graph Line Fill",
    offsetof(zmapFeatureTypeStyleStruct, mode_data.graph.line_fill) ,ZMAPSTYLE_MODE_GRAPH },
