 ...
 * CVS info:   $Id: zmapWindowAssemblyFeature.c,v 1.3 2010-03-04 15:11:43 mh17 Exp $
 *-------------------------------------------------------------------
 */
						    ...
						    GdkColor              *default_fill)
{
  ...
  ZMapStyleColourTarget colour_target;
  ...
  switch(sub_feature->subpart)
    ...
    case ZMAPFEATURE_SUBPART_GAP:
      {
	colour_target = ZMAPSTYLE_COLOURTARGET_NON_ASSEMBLY_PATH;
      }
      break;
    case ZMAPFEATURE_SUBPART_MATCH:
    default:
      colour_target = ZMAPSTYLE_COLOURTARGET_NORMAL;
      break;
    }
