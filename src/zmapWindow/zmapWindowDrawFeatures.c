 ...
 * Exported functions: 
 * HISTORY:
 * Last edited: Dec 13 11:51 2005 (rds)
 * Created: Thu Jul 29 10:45:00 2004 (rnc)
 * CVS info:   $Id: zmapWindowDrawFeatures.c,v 1.105 2005-12-13 11:53:51 rds Exp $
 *-------------------------------------------------------------------
 */
					    ...
					    ZMapWindow window)
{
  ...
  if (!feature->feature.transcript.introns && !feature->feature.transcript.exons)
      ...
      if (feature->feature.transcript.exons)
	{
          ...
          GdkColor *cds_bg = background, *cds_bg_tmp = foreground;
	  ...
	  for (i = 0; i < feature->feature.transcript.exons->len; i++)
	    {
	      ...
	      exon_span = &g_array_index(feature->feature.transcript.exons, ZMapSpanStruct, i);
              ...
              if(feature->feature.transcript.flags.cds && 
                 (cds_start > bottom))
                cds_bg = cds_bg_tmp;  /* probably a reverse & cds_end thing here too! */
              else
                cds_bg = background;
