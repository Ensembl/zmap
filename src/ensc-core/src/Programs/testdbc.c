...
int main(int argc, char *argv[]) {
  ...
  const char *dbname = "homo_sapiens_core_70_37";
  ...
  printf("Opening connection for '%s' ...", dbname);
  dba = DBAdaptor_new("ensembldb.ensembl.org","anonymous",NULL,dbname,5306,NULL);
